...
public class ParadaDAO implements operacionesCRUD<Parada> {
	...
	public Collection<Parada> buscarTodos() {
		// TODO Auto-generated method //hay que declarar esto fuera del of para cerrarlo
		// correctamente
		Connection co = null;
	...
	// creo un metodo fuera del crud para poder pasdar como argumento tambien el id
	// de credenciales
